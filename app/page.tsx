...
function Portfolio() {
  ...
  // Social media icons using custom SVG (removed GitHub)
  const LinkedInIcon = () => (
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? "dark" : ""}`}>
      ...
      <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50">
        <div className="bg-white/80 dark:bg-black/80 backdrop-blur-xl border border-gray-200/20 dark:border-white/10 rounded-2xl px-6 md:px-8 py-4 shadow-2xl shadow-black/10 dark:shadow-black/30 w-[calc(100vw-2rem)] md:w-auto max-w-5xl">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8 flex-1 justify-center ml-12">
          ...
          >
            <div className="space-y-2">
              ...
              {/* Mobile Social Icons - Removed GitHub */}
