  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? "dark" : ""}`}>
      ...
      <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50">
        <div className="bg-white/80 dark:bg-black/80 backdrop-blur-xl border border-gray-200/20 dark:border-white/10 rounded-2xl px-4 md:px-6 py-3 shadow-lg dark:shadow-2xl dark:shadow-black/30 w-[calc(100vw-2rem)] md:w-auto max-w-4xl">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="opacity-0 animate-fade-in-up -mt-16 md:mt-0">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              <div 
                ...
                style={{ height: `${workExperience.length > 1 ? (workExperience.length - 1) * 12 : 0}rem` }}
              ></div>
              {workExperience.map((job, index) => (
                <div key={index} className="relative flex items-start mb-12 last:mb-0">
                  <div className="absolute left-4 md:left-6 w-4 h-4 bg-[#0066ff] rounded-full border-4 border-white dark:border-[#0f0f10]"></div>
