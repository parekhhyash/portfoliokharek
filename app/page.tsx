  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="absolute inset-0">
        <div
          className="absolute top-1/2 left-1/2 w-[400px] h-[400px] md:w-[600px] md:h-[600px] -translate-x-1/2 -translate-y-1/2 opacity-25"
          style={{
      ...
      {/* Main Content */}
      <main className="relative z-10 flex items-center justify-center min-h-[calc(100vh-200px)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
            {/* Web3 Marketer Card */}
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border-2 hover:border-[#0066ff]/30 bg-black/80 backdrop-blur-xl border-white/10">
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <Button
                  size="lg"
                  className="w-full bg-[#0066ff] hover:bg-[#0052cc] text-white py-3 text-base md:text-lg font-medium transition-all duration-200 hover:scale-105 group-hover:shadow-lg"
                  onClick={() => window.location.href = '/marketer'}
                >
                  Explore Marketing Portfolio
            ...
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border-2 hover:border-[#0066ff]/30 bg-black/80 backdrop-blur-xl border-white/10">
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full border-2 border-[#0066ff] text-[#0066ff] hover:bg-[#0066ff] hover:text-white py-3 text-base md:text-lg font-medium transition-all duration-200 hover:scale-105 group-hover:shadow-lg bg-transparent"
                  onClick={() => window.location.href = '/programmer'}
                >
                  Explore Dev Portfolio
                  <ArrowRight className="ml-2 h-4 w-4 md:h-5 md:w-5" />
                </Button>
              </CardContent>
            </Card>
